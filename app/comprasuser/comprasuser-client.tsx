      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Revisa el estado de tus pedidos y rastreo de envíos</p>
          </div>
        ...
        {!Array.isArray(orders) || orders.length === 0 ? (
          <Card className="shadow-xl">
            <CardContent className="p-16 text-center">
              ...
              <h2 className="text-2xl font-bold mb-3 text-gray-900">No tienes compras todavía</h2>
              <p className="text-gray-600 mb-6">Tus compras aparecerán aquí una vez que realices un pedido</p>
